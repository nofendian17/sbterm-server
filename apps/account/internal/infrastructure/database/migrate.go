...
import (
	...
	accountmigrations "github.com/nofendian17/sbterm/apps/account/migrations/account"
	// postgres driver: registers the "postgres://" URL scheme via its init().
	_ "github.com/golang-migrate/migrate/v4/database/postgres"
	"github.com/golang-migrate/migrate/v4/source/iofs"
)

// migrationsFS holds the embedded account migration SQL files.
var migrationsFS = accountmigrations.FS

// RunMigrations applies the embedded account migrations (users, rbac, watchlists)
